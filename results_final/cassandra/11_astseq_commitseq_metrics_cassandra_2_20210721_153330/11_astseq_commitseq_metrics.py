...
cfg.typesInput                  = [cfg.TypeInput.astseq, cfg.TypeInput.commitseq, cfg.TypeInput.codemetrics, cfg.TypeInput.processmetrics]
cfg.pathsSampleTrain            = ["../datasets/{}/output/R{}_r_train".format(cfg.project, cfg.release)]
cfg.pathsSampleTest             = ["../datasets/{}/output/R{}_r_test".format(cfg.project, cfg.release)]
