...
cfg.pathsSampleTrain            = ["../../MLTool/datasets/{}/output50%/R{}_r_train".format(cfg.project, cfg.release)]
cfg.pathsSampleTest             = ["../../MLTool/datasets/{}/output50%/R{}_r_test".format(cfg.project, cfg.release)]
