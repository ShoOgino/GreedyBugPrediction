...
cfg.pathsSampleTrain            = ["../../MLTool/datasets/{}/output80%/R{}_r_train".format(cfg.project, cfg.release)]
cfg.pathsSampleTest             = ["../../MLTool/datasets/{}/output80%/R{}_r_test".format(cfg.project, cfg.release)]
cfg.adoptingCrossValidation     = False
cfg.splitSize4Validation        = 5
cfg.epochs4EarlyStopping        = 10
cfg.period4HyperParameterSearch = 60*60*20
