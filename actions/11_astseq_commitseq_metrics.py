...
cfg.typesInput                  = ["astseq", "commitseq", "codemetrics", "processmetrics"]#["ast", "astseq", "codemetrics", "commitgraph", "commitseq", "processmetrics"]
...
cfg.pathDirOutput               = os.path.dirname(os.path.dirname(__file__)) + "/results/" + cfg.id + datetime.datetime.today()
